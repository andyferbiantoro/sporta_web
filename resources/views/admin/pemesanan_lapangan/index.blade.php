...
<div class="modal fade" id="ModalAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
        <form method="post" action="{{route('admin_pesan_lapangan_add')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select type="text" class="form-control" id="id_pelanggan" name="id_pelanggan" required="">
...
<div class="form-group">
  ...
  <input type="number" class="form-control" id="nominal_dp" name="nominal_dp" required="" disabled=""></input>
</div>

<div class="form-group">
  <label for="catatan">Catatan (Opsional)</label>
  <textarea type="file" class="form-control" id="catatan" name="catatan" required=""></textarea>
</div>
