                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-body text-left">
                               <div class="text-left">
                                 <h1>GALERI</h1><br>
                                <a href="{{route('admin_kelola_konten')}}"><button type="button" class="btn btn-success ">
                                   Kelola Galeri
                                </button></a>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="card-body text-left">
                ...
                <div class="text-left">
                   <h1>PENGUMUMAN</h1><br>
                   <a href="{{route('admin_kelola_pengumuman')}}"><button type="button" class="btn btn-success ">
                    Kelola Pengumuman
                </button></a><br><br>
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
