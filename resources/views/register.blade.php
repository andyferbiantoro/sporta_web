                             ...
                             @if (session('success'))
                                    ...
                                    <form class="user" action="{{route('proses-register')}}" method="post">
                                       ...
                                       <div class="form-group">
                                        <input type="text" name="nama_pelanggan" class="form-control form-control-user" id="nama"
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="no_hp" class="form-control form-control-user" id="exampleInputEmail"
