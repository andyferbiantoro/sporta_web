<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            ...
            @if(Auth::user()->role == "admin")
                ...
                <li class="{{(request()->is('admin')) ? 'active' : ''}}"><a class="d-flex align-items-center" href="app-email.html"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboard">Dashboard</span></a>
                </li>
                ...
                <li class="{{(request()->is('admin_data_pelanggan')) ? 'active' : ''}} nav-item"><a class="d-flex align-items-center" href="{{route('admin_data_pelanggan')}}"><i data-feather="users"></i><span class="menu-title text-truncate" data-i18n="file">Data Pelanggan</span></a>
                </li>
